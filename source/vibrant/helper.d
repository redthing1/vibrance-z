...
string toSnakeCase(Str)(Str str) if (isSomeString!Str) {
...
string stripPrefix(string Prefix, Str)(Str str) if (isSomeString!Str) {
	auto r1 = ctRegex!("^" ~ Prefix);
	return str.replaceAll(r1, "");
}

string stripSuffix(string Suffix, Str)(Str str) if (isSomeString!Str) {
